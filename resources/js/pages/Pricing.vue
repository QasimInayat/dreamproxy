                                ...
                                <div class="nk-content-wrap">
                                            ...
                                            <table class="table table-features">
                                                ...
                                                <tbody class="tb-ftr-body">
                                                    <tr class="tb-ftr-item">
                                                        ...
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-check-thick"></em>
                                                            <span class="plan-name">Starter</span></td>
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-check-thick"></em>
                                                            <span class="plan-name">Pro</span></td>
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-check-thick"></em>
                                                            <span class="plan-name">Enterprise</span></td>
                                                    </tr>
                                                    <tr class="tb-ftr-item">
                                                    ...
                                                    <tr class="tb-ftr-item">
                                                        ...
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-cross"></em> <span
                                                                class="plan-name">Starter</span></td>
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-check-thick"></em>
                                                            <span class="plan-name">Pro</span></td>
                                                        <td class="tb-ftr-plan"><em class="icon ni ni-check-thick"></em>
                                                            <span class="plan-name">Enterprise</span></td>
                                    ...
                                    <div class="nk-block">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="nk-help">
                                                    <div class="nk-help-img"><svg xmlns="http://www.w3.org/2000/svg"
                                                            viewbox="0 0 120 118">
                                                            <path
                                                            ...
                                                            <circle cx="90.5" cy="97.5" r="3" fill="none"
                                                                stroke="#9cabff" stroke-miterlimit="10"></circle>
                                                            <circle cx="24" cy="23" r="2.5" fill="none" stroke="#9cabff"
                                                                stroke-miterlimit="10"></circle>
                                                        </svg></div>
                                                    <div class="nk-help-text">
                                                        <h5>We’re here to help you!</h5>
                                                        <p class="text-soft">Ask a question or file a support ticket or
                                                            report an issues. Our team support team will get back to you
                                                            by email.</p>
                                                    </div>
                                                    <div class="nk-help-action"><a href="contact.html"
                                                            class="btn btn-lg btn-outline-primary">Get Support Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
