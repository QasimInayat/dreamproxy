                    ...
                    <div class="nk-split nk-split-page nk-split-md">
                        <div
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <form action="/landing/pages/auths/auth-login.html">
                                ...
                                <div class="form-note-s2 pt-4"> Already have an account ? <router-link
                                        to="/login"><strong>Sign in instead</strong></router-link></div>
