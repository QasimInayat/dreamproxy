                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center"><img class="nk-error-gfx"
                                src="images/gfx/error-404.svg" alt="">
                            <div class="wide-xs mx-auto">
                                ...
                                <p class="nk-error-text">We are very sorry for inconvenience. It looks like you’re try
                                    to access a page that either has been deleted or never existed.</p><router-link
                                    to="/" class="btn btn-lg btn-primary mt-2">Back To Home</router-link>
                            </div>
                        </div>
                    </div>
                </div>
